...
proc create_hier_cell_trigger_memory_block { parentCell nameHier } {
  ...
  connect_bd_net -net S_AXI_ARESETN_3 [get_bd_pins S_AXI_ARESETN] [get_bd_pins muon_memory_block/s_axi_aresetn] [get_bd_pins sde_trigger_0/s00_axi_aresetn] [get_bd_pins sde_trigger_0/s_axi_intr_aresetn] [get_bd_pins shower_memory_block/s_axi_aresetn]
  connect_bd_net -net S_AXI_CLK_3 [get_bd_pins S_AXI_CLK] [get_bd_pins muon_memory_block/s_axi_aclk] [get_bd_pins sde_trigger_0/s00_axi_aclk] [get_bd_pins sde_trigger_0/s_axi_intr_aclk] [get_bd_pins shower_memory_block/s_axi_aclk]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net In_regional_ck_0_IBUF_OUT [get_bd_pins adc_inputs/CLK120] [get_bd_pins clock_1pps_0/CLK120] [get_bd_pins filter_block/CLK] [get_bd_pins interface_uub_dfn3_0/CLK120] [get_bd_pins time_tagging_0/clk_120m] [get_bd_pins trigger_memory_block/TRIGGER_CLK] [get_bd_pins util_ds_buf_0/IBUF_OUT]
  ...
  connect_bd_net -net adc_inputs_SYNC_OUT0 [get_bd_pins adc_inputs/SYNC_OUT0] [get_bd_pins filter_block/IN0] [get_bd_pins trigger_memory_block/ADC0]
  connect_bd_net -net adc_inputs_SYNC_OUT1 [get_bd_pins adc_inputs/SYNC_OUT1] [get_bd_pins filter_block/IN1] [get_bd_pins trigger_memory_block/ADC1]
  connect_bd_net -net adc_inputs_SYNC_OUT2 [get_bd_pins adc_inputs/SYNC_OUT2] [get_bd_pins filter_block/IN2] [get_bd_pins trigger_memory_block/ADC2]
  connect_bd_net -net adc_inputs_SYNC_OUT3 [get_bd_pins adc_inputs/SYNC_OUT3] [get_bd_pins trigger_memory_block/ADC3]
  connect_bd_net -net adc_inputs_SYNC_OUT4 [get_bd_pins adc_inputs/SYNC_OUT4] [get_bd_pins trigger_memory_block/ADC4]
  ...
  connect_bd_net -net interface_uub_dfn3_0_PPS [get_bd_pins interface_uub_dfn3_0/PPS] [get_bd_pins time_tagging_0/pps] [get_bd_pins trigger_memory_block/ONE_PPS]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins interface_uub_dfn3_0/s00_axi_aresetn] [get_bd_pins time_tagging_0/s00_axi_aresetn] [get_bd_pins trigger_memory_block/S_AXI_ARESETN] [get_bd_pins zync_block/peripheral_aresetn]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins interface_uub_dfn3_0/s00_axi_aclk] [get_bd_pins time_tagging_0/s00_axi_aclk] [get_bd_pins trigger_memory_block/S_AXI_CLK] [get_bd_pins zync_block/FCLK_CLK0]
