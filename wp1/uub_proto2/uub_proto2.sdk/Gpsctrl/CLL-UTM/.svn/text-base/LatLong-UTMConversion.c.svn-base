     ...
     double *UTMNorthing, double *UTMEasting, char* UTMZone)
{
  ...
  LongTemp = (Longi+180) - (int)((Longi+180)/360)*360-180 ;
...
char UTMLetterDesignator(double Lat)
{
  ...
  else LetterDesignator = 'Z'; /*This is here as an error flag to show*/
     ...
     double *Lat,  double *Long )
{
  ...
  if((*ZoneLetter - 'N') >= 0)
  ...
  else
    {
      ...
      y -= 10000000.0; /*remove 10,000,000 meter offset used for
 southern hemisphere*/
    }
